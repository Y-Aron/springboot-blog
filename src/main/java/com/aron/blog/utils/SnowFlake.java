...
public class SnowFlake {
     ...
     * 起始的时间戳
     */
    private final static long START_TIME_STAMP = 1539013334539L;
    ...
    public SnowFlake(long dataCenterId, long machineId) {
        if (dataCenterId > MAX_DATA_CENTER_NUM || dataCenterId < 0) {
            throw new IllegalArgumentException("data centerId can't be greater than MAX_DATA_CENTER_NUM or less than 0");
        }
